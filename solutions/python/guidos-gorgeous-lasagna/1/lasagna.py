...
def preparation_time_in_minutes(number_of_layers):
    ...
    Parameters:
        number_of_layers (int): Number of layers added to the lasagna.

    Returns:
        int: preparation time (in minutes) derived from 'PREPARTION_TIME'
...
def elapsed_time_in_minutes(numbers_of_layers, elapsed_bake_time):
    ...
    Function that takes the number_of_layers added and the time already spent and returns how many minutes passed in total.
    """
